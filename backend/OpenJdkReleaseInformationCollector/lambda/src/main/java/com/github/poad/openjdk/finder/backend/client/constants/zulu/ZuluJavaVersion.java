...
class ZuluJavaVersion extends JavaVersion {
    public ZuluJavaVersion(String zuluVersion, int majorVersion, String arch, String version, String installationType, String extension, String os, String bundle, Boolean fx, String checksumType, String checksum) {
        super(Vendor.ZULU.getVendor(), Distribution.ZULU.getDistribution(), majorVersion, arch, version, installationType, extension, asDownloadUrl(zuluVersion, arch, version, extension, os, bundle, fx), "hotspot", os, bundle, fx, checksumType, checksum, null, null);
    }
    ...
    private static String asDownloadUrl(String zuluVersion, String arch, String version, String extension, String os, String bundle, Boolean fx) {
        return String.join(
                "",
                arch.equals(Arch.ARM64.getArch()) ? "https://cdn.azul.com/zulu-embedded/bin/zulu" : "https://cdn.azul.com/zulu/bin/zulu",
                zuluVersion,
                "-ca-",
                fx ? "fx-" : "",
                bundle,
                ...
                arch.equals(Arch.X86.getArch()) ? "i686" : arch,
                ".",
                extension);
    }
}
