...
abstract class AdoptOpenJ9JdkVersion extends AdoptJdkVersion {
    public AdoptOpenJ9JdkVersion(int majorVersion, int build, String j9Version, String arch, String version, String installationType, String extension, String os, String checksum) {
        super(
