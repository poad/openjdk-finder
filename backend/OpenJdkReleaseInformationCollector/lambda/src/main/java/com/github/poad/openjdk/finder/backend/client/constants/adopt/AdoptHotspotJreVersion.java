...
public class AdoptHotspotJreVersion extends AdoptJreVersion {
    public AdoptHotspotJreVersion(int majorVersion, int build, String arch, String version, String installationType, String extension, String os, String checksum) {
        super(
